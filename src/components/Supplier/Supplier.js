...
class Supplier extends Component {
    constructor(props) {
        ...
        this.state = {
            supplier: [],
            supplierInput: '',
            url: 'http://localhost:64294/api/Suppliers',
            resultData: {
                currentPage: 0,
                success: false,
                total: 0,
                            ...
                            <Panel.Body>
                                ...
                                <FormGroup controlId="formHorizontal_Name" validationState={this.state.isInputValid} >
                                    <FieldGroup
                                        ...
                                        inputRef={(ref) => { this.supplierName = ref }}                                       
                                    />
   ...
   <HelpBlock className="has-error">
                    ...
                    <Col xs={12} md={7}>
                        <Panel bsStyle="default">
                            <Panel.Heading>
                                <Panel.Title componentClass="h3">List of Suppliers
                                </Panel.Title>
                            </Panel.Heading>
                            <Panel.Body>
                                <BootstrapTable data={this.state.supplier} 
                                    options={this.pagingTable(this.state.supplier.length)}
                                    striped hover>
                                    <TableHeaderColumn dataField='id' isKey={true} width="80" >ID</TableHeaderColumn>
                                    <TableHeaderColumn dataField='name' width="160">Supplier Name</TableHeaderColumn>
                                    <TableHeaderColumn
                                        dataField='button'
                                        width="100"
