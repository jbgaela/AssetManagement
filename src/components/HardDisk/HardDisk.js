...
class HardDisks extends Component {
    constructor(props) {
        super(props);
        this.state = {
            harddisk: [],
            harddiskInput: '',
            url: 'http://localhost:64294/api/Sizes/harddisk',
            resultData: {
                currentPage: 0,
                success: false,
                total: 0,
            ...
            <Grid>
                <Row className="show-grid">
                            ...
                            <Panel.Body>
                                ...
                                <FormGroup controlId="formHorizontal_Name" validationState={this.state.isInputValid} >
                                    <FieldGroup
                                        ...
                                        placeholder="Please enter Hard disk size."
                                        inputRef={(ref) => { this.harddiskName = ref }}                                       
                                    />
                                </FormGroup>
                    ...
                    <Col xs={12} md={7}>
                        <Panel bsStyle="default">
                            <Panel.Heading>
                                <Panel.Title componentClass="h3">Hard disk sizes
                                </Panel.Title>
                            </Panel.Heading>
                            <Panel.Body>
                                <BootstrapTable data={this.state.harddisk} 
                                    options={this.pagingTable(this.state.harddisk.length)}
                                    striped hover>
                                    <TableHeaderColumn dataField='id' isKey={true} width="80" >ID</TableHeaderColumn>
                                    <TableHeaderColumn dataField='size' width="160">Hard disk size</TableHeaderColumn>
                                    <TableHeaderColumn
                                        dataField='button'
                                        width="100"
