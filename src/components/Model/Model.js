...
class Models extends Component {
    constructor(props) {
        ...
        this.state = {
            model: [],
            modelInput: '',
            url: 'http://localhost:64294/api/Models',
            resultData: {
                currentPage: 0,
                success: false,
                total: 0,
            ...
            <Grid>
                <Row className="show-grid">
                            ...
                            <Panel.Body>
                                ...
                                <FormGroup controlId="formHorizontal_Name" validationState={this.state.isInputValid} >
                                    <FieldGroup
                                        ...
                                        inputRef={(ref) => { this.modelName = ref }}                                       
                                    />
                                </FormGroup>
                    ...
                    <Col xs={12} md={7}>
                        <Panel bsStyle="default">
                            <Panel.Heading>
                                <Panel.Title componentClass="h3">List of models
                                </Panel.Title>
                            </Panel.Heading>
                            <Panel.Body>
                                <BootstrapTable data={this.state.model} 
                                    options={this.pagingTable(this.state.model.length)}
                                    striped hover>
                                    <TableHeaderColumn dataField='id' isKey={true} width="80" >ID</TableHeaderColumn>
                                    <TableHeaderColumn dataField='name' width="160">Model Name</TableHeaderColumn>
                                    <TableHeaderColumn
                                        dataField='button'
                                        width="100"
